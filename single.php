  ...
  <div class="wrapper">
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        <article class="single-post content-narrow">
          ...
          <div class="post-meta">
            <div class="author">
              <img src="https://www.uifrommars.com/wp-content/uploads/2024/03/cbusquets-avatar-40.jpg" class="avatar" alt="Cris Busquets">
              <span class="meta">Escrito por
                <?php the_author_posts_link(); ?></span>
            </div>
            <div class="reading-time">
              <img class="icon" src="<?php echo get_bloginfo('template_url') ?>/assets/images/icon/clock.svg" /><span class="meta">Tiempo de lectura: <span class="minutes"></span> minutos</span>
            </div>
          </div>
          ...
          <div id="share-article">
            ...
            <button id="copy-url-btn" class="plausible-event-name=Share+Article"><img src="<?php echo get_bloginfo('template_url') ?>/assets/images/icon/copy.svg" width="18" height="18" alt="icono copiar enlace" /> Copiar enlace</button>
          </div>
          <hr />
