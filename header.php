  ...
  <header>
    <div class="wrapper">
      ...
      <div id="search-icon" class="show">
        <img src="<?php echo get_bloginfo('template_url') ?>/assets/images/icon/magnifying-glass.svg" width="28" height="28" alt="icono lupa buscar" />
      </div>
      ...
      <dialog id="dialog">
        <div id="dialog-header">
          ...
          <img src="<?php echo get_bloginfo('template_url') ?>/assets/images/icon/x-mark.svg" width="28" height="28" alt="icono aspa cerrar" class="close" />
        </div>
        <?php get_search_form(); ?>
      </dialog>
    </div>
