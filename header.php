...
<body>
  ...
  <div id="marquee">
    ...
    <button id="close-marquee" aria-label="Cerrar barra superior"> <img src="<?php echo get_bloginfo('template_url') ?>/assets/images/icon/x-mark-white.svg" width="16" height="16" alt="icono aspa cerrar" class="Cerrar barra superior" /></button>
