...
<body>
  ...
  <div id="marquee">
    ...
    <span id="close-marquee" aria-label="Cerrar barra superior" class="plausible-event-name=Close+Top+Bar"> <img
        src="<?php echo get_bloginfo('template_url') ?>/assets/images/icon/x-mark-white.svg" width="16" height="16"
        alt="icono aspa cerrar" /></span>
  ...
  <header>
    <div class="wrapper">
      ...
      <div id="extra">
        ...
        <span class="hamburger hamburger--squeeze nav-toggle" aria-label="Abrir menú navegación" aria-expanded="false">
